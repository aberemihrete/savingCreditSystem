...
<div class="container">
 ...
 <div class="col-md-8">
 <div class="card">
 <div class="card-header">{{ __('managers Registration') }}</div>
 <div class="card-body">
...
="sex">
 ...
 <div class="col-md-6">
 <input id="zone" type="text" class="formcontrol @error('price') isinvalid @enderror" name="zone" value="{{ old('zone') }}" required autocomplete
="zone">
 @error('zone')
 <span class="invalid-feedback" role="alert">
 <strong>{{ $message }}</strong>
